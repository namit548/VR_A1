...
namespace Meta.XR.MRUtilityKit
{
    ...
    public class DestructibleGlobalMeshSpawnerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                if (Meta.XR.MRUtilityKit.Utilities.EnsurePlayMode())
                {
                    Meta.XR.MRUtilityKit.Utilities.ExecuteAction(
            ...
            if (GUILayout.Button("Clear Spawned Mesh"))
            {
                if (Meta.XR.MRUtilityKit.Utilities.EnsurePlayMode())
                {
                    Meta.XR.MRUtilityKit.Utilities.ExecuteAction(() => spawner.RemoveDestructibleGlobalMesh(),
